...
export default function CustomerOrderCompleted({ order }: { order: OrderPayload }) {
      ...
      <Body style={main}>
        <Container style={container}>
          <Section style={headerSection}>
            ...
            <Text style={receiptTitle}>ORDER COMPLETED</Text>
          </Section>
          ...
          <Section style={contentSection}>
            ...
            <Text style={description}>
              Your order is complete. We have successfully processed your transaction. {isBuy ? `The ${order.asset} has been released to your wallet.` : 'The NGN has been transferred to your bank account.'}
            </Text>
          </Section>
          ...
          <Section style={boxSection}>
            <Row>
              ...
              <Column align="right">
                <Text style={label}>DATE COMPLETED</Text>
                <Text style={value}>{new Date().toLocaleDateString('en-GB')}</Text>
              </Column>
            </Row>
            <Hr style={subDivider} />
            <Row>
          ...
          <Section style={highlightSection}>
            ...
            <Text style={label}>{isBuy ? 'YOU PAID' : 'YOU RECEIVED'}</Text>
